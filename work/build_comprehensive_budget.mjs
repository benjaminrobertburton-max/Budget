...
tuesday.getRange("A2:G2").merge();tuesday.getRange("A2").values=[["Use this live checklist after Start is verified. Done means no manual action is required. Automatic transfers remain part of the cash plan even when marked Done; bank settlement is verified at the next weekly import."]];tuesday.getRange("A2:G2").format={font:{italic:true,color:gray},wrapText:true};
...
tuesday.getRange("F9:F19").values=[["Not done"],["Not done"],["Not due"],["Not done"],["Not done"],["Not done"],["Done"],["Done"],["Done"],["Done"],["Not done"]];tuesday.getRange("F9:F19").dataValidation={rule:{type:"list",values:["Not done","Done","✓ Done","Not due","Scheduled","Deferred","Partial"]}};
