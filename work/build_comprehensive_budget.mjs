...
tuesday.getRange("E9:E19").values=[["☐ Pay now"],["☐ Pay now"],["— Not due"],["☐ Pay now"],["☐ Pay now"],["☐ Pay now"],["Auto — no click"],["Auto — no click"],["Auto — no click"],["Auto — no click"],["— Not needed"]];
...
dash.getRange("B5").formulas=[["='2. Tuesday Review'!E22"]];dash.getRange("B6").formulas=[["='2. Tuesday Review'!E21"]];dash.getRange("B7").formulas=[["='2. Tuesday Review'!E24"]];dash.getRange("B8").formulas=[["=B5+B7-B6"]];dash.getRange("C8").formulas=[["=IF(COUNTIF(E6:E13,\"<>Verified\")>0,\"Resolve source checks in Start\",IF(COUNTBLANK('Support - Debt Detail'!D5:D15)>0,\"Update missing statement / due dates in Debt Detail\",\"Complete the open items in Tuesday Review\"))"]];
