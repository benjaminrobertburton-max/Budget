...
cash.getRange("A12:J21").values=[
 ...
 ["Citi AAdvantage","Citi activity — Sep 15","Posted ledger rows","",null,"",null,"",null,"Capture posted activity through the saved anchor"],
...
cash.getRange("I14").formulas=[["=IF(D14=\"\",\"Needed\",IF(E14<>D14,\"Missing entry\",IF(ABS(G14-F14)>0.005,\"Total mismatch\",IF(H14<>\"Yes\",\"Anchor not reached\",\"Verified\"))))"]];cash.getRange("I15").formulas=[["=IF(D15=\"\",\"Needed\",IF(E15<>D15,\"Missing entry\",IF(ABS(G15-F15)>0.005,\"Total mismatch\",IF(H15<>\"Yes\",\"Anchor not reached\",\"Verified\"))))"]];cash.getRange("I16").formulas=[["=IF(D16=\"\",\"Needed\",IF(E16<>D16,\"Missing entry\",IF(ABS(G16-F16)>0.005,\"Total mismatch\",IF(H16<>\"Yes\",\"Anchor not reached\",\"Verified\"))))"]];cash.getRange("I18").formulas=[["=IF(D18=\"\",\"Needed\",IF(E18<>D18,\"Missing entry\",IF(ABS(G18-F18)>0.005,\"Total mismatch\",IF(H18<>\"Yes\",\"Anchor not reached\",\"Verified\"))))"]];
...
dash.getRange("E6:E13").conditionalFormats.add("containsText",{text:"Needed",format:{fill:yellow,font:{bold:true,color:"#7C5E10"}}});dash.getRange("E6:E13").conditionalFormats.add("containsText",{text:"Source check",format:{fill:red,font:{bold:true,color:"#B91C1C"}}});
