...
cash.getRange("A12:J21").values=[
 ...
 ["Prime Visa","Prime balance / activity — Sep 15","Balance + activity","","","","","","Needed","Balance confirmed $0.00; capture activity before verification"],
 ["Discover","Discover balance / activity — Sep 15","Balance + activity","",null,"",null,"",null,"Balance confirmed $0.00; capture activity before verification"],
...
tuesday.getRange("A6:G6").values=[[null,"Sep 1–Sep 7 purchases","", "Await remaining imports",null,null,null]];
...
tuesday.getRange("G9:G20").values=[["Pay the current balance if maintaining the weekly payoff routine"],["Pay the current balance if maintaining the weekly payoff routine"],["No payment needed; activity still needs capture"],["No payment needed; activity still needs capture"],["No payment needed"],["Five weekly payments remain before Oct. 10"],["Actual Sep. 9 transfer retained; do not revise this completed funding amount"],["Move to CUTX reserve; do not pay the loan early"],["Do not count again in cash required"],["Automatic commitment; included in cash required"],["Automatic commitment; included in cash required"],["Automatic commitment; included in cash required"]];tuesday.getRange("G21").formulas=[["=IF(D21=0,\"No transfer needed after net rent funding\",\"Additional funding required after adding Discover\")"]];
