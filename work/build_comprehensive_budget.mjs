...
tuesday.getRange("A2:G2").merge();tuesday.getRange("A2").values=[["Use this live checklist after Start is verified. Change Check off to ☑ Done as you complete a manual payment. Auto — no click needs no Tuesday action; it remains in the cash plan and is verified at the next weekly import."]];tuesday.getRange("A2:G2").format={font:{italic:true,color:gray},wrapText:true};
...
tuesday.getRange("E21:E24").format={fill:pale,font:{bold:true,size:14},numberFormat:usd,borders:{preset:"outside",style:"medium",color:"#A7C9C8"}};tuesday.getRange("D9:D19").format.numberFormat=usd;tuesday.getRange("A1:G24").format.wrapText=true;tuesday.getRange("A9:G19").format.rowHeight=25;widths(tuesday,[["A:A",18],["B:B",28],["C:C",21],["D:D",18],["E:E",19],["F:F",13],["G:G",41]]);tuesday.getRange("A1:G24").format.font={size:12};tuesday.showGridLines=false;tuesday.freezePanes.freezeRows(8);
