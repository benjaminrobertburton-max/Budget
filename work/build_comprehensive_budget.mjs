...
polish(tuesday,"A1:G24","A1:G1","A2:G2",["A4:G4"]);tuesday.getRange("A5:G6").format.rowHeight=24;tuesday.getRange("A8:G8").format.rowHeight=23;tuesday.getRange("A9:G19").format.rowHeight=28;tuesday.getRange("D9:D19").format.font={name:"Arial",size:11,bold:true,color:"#243447"};tuesday.getRange("E9:F19").format.horizontalAlignment="center";tuesday.getRange("E21:E24").format.font={name:"Arial",size:13,bold:true,color:"#172B4D"};
