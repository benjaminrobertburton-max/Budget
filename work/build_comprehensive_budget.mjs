...
savings.getRange("B26").formulas=[["='Support - Budget Inputs'!$E$12"]];savings.getRange("B26:B29").fillDown();savings.getRange("C26").formulas=[["='2. Tuesday Review'!D15"]];savings.getRange("D26").formulas=[["=C26-B26"]];savings.getRange("D26:D29").fillDown();
