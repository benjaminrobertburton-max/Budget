...
tuesday.getRange("A2:G2").merge();tuesday.getRange("A2").values=[["Use this checklist after Start is verified. Change Check off to ☑ Done as you complete a manual payment. Auto — no click requires no Tuesday action but remains in the cash plan."]];tuesday.getRange("A2:G2").format={font:{italic:true,color:gray},wrapText:true};
...
tuesday.getRange("E9:E21").values=[["☐ Pay now"],["☐ Pay now"],["— Not due"],["— Not due"],["— Not due"],["☐ Pay now"],["— Not needed"],["☐ Pay now"],["Auto — no click"],["Auto — no click"],["Auto — no click"],["Auto — no click"],["☐ Pay now"]];
tuesday.getRange("E9:E21").dataValidation={rule:{type:"list",values:["☐ Pay now","☑ Done","Partial","— Not due","Auto — no click","— Not needed"]}};
...
tuesday.getRange("E9:E21").format={fill:yellow,font:{color:"#0000FF",bold:true},horizontalAlignment:"center"};
tuesday.getRange("F9:F21").format={fill:pale,font:{color:gray},horizontalAlignment:"center"};
tuesday.getRange("E9:E21").conditionalFormats.add("containsText",{text:"☐ Pay now",format:{fill:yellow,font:{bold:true,color:"#7C5E10"}}});
tuesday.getRange("E9:E21").conditionalFormats.add("containsText",{text:"☑ Done",format:{fill:mint,font:{bold:true,color:green}}});
tuesday.getRange("E9:E21").conditionalFormats.add("containsText",{text:"Auto",format:{fill:"#E8EEF5",font:{bold:true,color:gray}}});
tuesday.getRange("E9:E21").conditionalFormats.add("containsText",{text:"Not",format:{fill:"#E8EEF5",font:{color:gray}}});
